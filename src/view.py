...
class View(QMainWindow):
    ...
    def reset(self) -> None:
        ...
        self.output.setText("Währung Konvertieren ...")
    ...
    def set_output(self, text: str) -> None:
        """
        This function sets the text of the output label to the text passed in as a parameter

        :param text: The text to be displayed in the output label
        :type text: str
        """
